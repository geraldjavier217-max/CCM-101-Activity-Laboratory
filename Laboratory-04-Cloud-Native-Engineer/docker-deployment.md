...
* `screenshots/nginx-running.png` — Successful Nginx response using `curl`.
* `screenshots/container-lifecycle.png` — Container stop, verification, and removal commands.
